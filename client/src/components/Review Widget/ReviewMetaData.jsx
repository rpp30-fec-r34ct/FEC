...
//     })
//     .then((data) => {
//       let [average, reviewCount] = calculateAverage(data.data)
//       let percent = calculatePercentRecommend(data.data.recommended.false, data.data.recommended.true)

//       setAllData(data, average, percent, reviewCount);
//     })
//     .catch((error) => {
//       console.error(error)
//     })
...
//     }
//     return ([Math.round((currentAverage / reviewCount) * 10) / 10, reviewCount])
//   }

//   const calculatePercentRecommend = (falseCount, trueCount) => {
//     const noCount = parseInt(falseCount)
//     const yesCount = parseInt(trueCount)

//     return Math.round((yesCount / (noCount + yesCount === 0 ? 1 : (noCount + yesCount))) * 100)
//   }

//   const setAllData = (data, average, percent, reviewCount) => {
//     setReviewsMeta({
//       reviewsMeta: data,
//       average: average,
//       percentRecommend: percent,
//       totalReviews: reviewCount
//     })
//   }

//   if (reviewsMeta.reviewsMeta === undefined) {
//     return (null);
//   } else {
//     return (
//       <>
...
//         </div>
//         <div>
//           <span data-testid='testPercent' className='percentRecommend'>{reviewsMeta.percentRecommend + '% of reviews recommend this product'}</span><br></br>
//         </div>
